  ...
  {[ if(activo != '0' || codigoODT == 0) { ]}
	...
	{[ } else { // esta definida ]} 
      ...
      <div style="text-align: left; float: left; width: 575px;margin-top:5px;color: #888;font-size: 14px">
        ...
        <span style="margin-left: 10px;">Definida por </span><span id="definidaPor"><strong>{{nombreDefinidor}}</strong></span>
        <span id="fechaDefinicion">{{fechaDefinicion}}</span>
      </div>
...
<div class="formularioEdicion">
  ...
  <ul style="margin-top:25px; margin-bottom:0">
    ...
    <li style="text-align:right;width: 550px;">
      ...
      <span style="margin: 2px;">ó</span>
      <a href="javascript:void()" onclick="$('#ventana-dialogo').hide()">Cerrar</a>
    </li>
