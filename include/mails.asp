...
Q = ""
        ...
        Q = Q & "<FONT face=Arial color=#000000 size=2>"
        Q = Q & "Numero: <b>" & rst("codigoODT") & "</B><BR>"
        Q = Q & "Solicitante: <b>" & obtenerNombre(rst("MNsolicitante")) & "</B><BR>"
        Q = Q & "Fecha: <B>" & formatoDia(rst("FechaHoraSolicitud")) & "</B><BR>"
        Q = Q & "Planta: <b>" & obtenerPlantaODT(rst("codigoPlanta")) & "</B><BR>"
        Q = Q & "Edificio: <b>" & obtenerEdificioODT(rst("codigoEdificio")) & "</B><BR>"
        Q = Q & "Ubicacion: <b>" & rst("UbicacionTarea") & "</B><BR>"
        Q = Q & "Contacto: <b>" & obtenerNombre(rst("MNcontacto")) & "</B><BR>"
        Q = Q & "Prioridad: <b>" & obtenerPrioridadODT(rst("codigoPrioridad")) & "</B><BR>"
        Q = Q & "Definidor: <b>" & obtenerNombre(rst("MNdefinidor")) & "</B><BR>"
        Q = Q & "Tarea: <b>" & rst("DescripcionODT") & "</B><BR>" 
    ...
    on error resume next		
        ...
        sendmail USUARIO_DEFAULT, "AMillach@dow.com", "ODT Nro: " & codigoODT, Q 		
      '  sendmailConAttach USUARIO_DEFAULT, "pcsuarez@dow.com",  "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s, codigoODT
       ' sendmailConAttach USUARIO_DEFAULT, "fferrarello@dow.com",  "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s, codigoODT
		' sendmailConAttach USUARIO_DEFAULT, "AMillach@dow.com",  "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s, codigoODT
		'sendmailConAttach USUARIO_DEFAULT, "JTESTARMATA@dow.com",  "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s, codigoODT
		'sendmailConAttach USUARIO_DEFAULT, "SIPERALTA@dow.com",  "ODT | Confirmada Orden de Trabajo Nro: " & codigoODT, s, codigoODT
